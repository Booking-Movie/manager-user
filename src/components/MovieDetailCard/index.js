const MovieEvaluate = props => {
  ...
  return (
    <>
      ...
      ) : evaluate !== 8 || evaluate !== 7 || evaluate !== 7.5 || evaluate !== 6.5 ? (
        <>
          <div class="flex items-center">
            <svg
              class="w-10 h-10 text-yellow-400"
      ...
      ) : evaluate !== 6 || evaluate !== 5.5 || evaluate !== 5 || evaluate !== 4.5 ? (
        <>
          <div class="flex items-center">
            <svg
              class="w-10 h-10 text-yellow-400"
      ...
      ) : evaluate !== 4 || evaluate !== 3.5 || evaluate !== 3 || evaluate !== 2.5 ? (
        <>
          <div class="flex items-center">
            <svg
              class="w-10 h-10 text-yellow-400"
      ...
      ) : evaluate !== 2 || evaluate !== 1.5 || evaluate !== 1 || evaluate !== 0.5 ? (
        <>
          <div class="flex items-center">
            <svg
              class="w-10 h-10 text-gray-300 dark:text-gray-500"
